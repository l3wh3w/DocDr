...
class SonucSayfaNotlari {
  static List<String> getSonucSayilari() {
    ...
    int birinciIsimToplam = (ResultList.birinciIsimList[SayfaListesi.birinciSayfaIndex].where((x) => x == 1).length +
    ...
    int toplamKitapSayisi = ResultList.indexList[SayfaListesi.ucuncuSayfaIndex].where((x) => x > 3).length +
